                    ...
                    <Box>
                        <Template
                            language="en"
                              ...
                              version="v1"
                              token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MzUxMzI4NzEsIkRhdGEiOnsiV2FsbGV0IjoiMHhEODVjNDEzZEE4MzNDZUJEODMzODEzOENjRUZBMDQ5NzlERjcwRThlIn19.e4wVNV6ZgOp1BxFUGiMqgNI0jiPB3BShYvmgTf0CxJk"
                              showRight={false}
                              theme={false}
